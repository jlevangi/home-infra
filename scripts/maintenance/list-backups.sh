...
#
# Usage:
#   ./scripts/maintenance/list-backups.sh                  # List prod backups from k3s-prod
#   ./scripts/maintenance/list-backups.sh --detailed       # Show individual backup IDs/timestamps
#   ./scripts/maintenance/list-backups.sh --all            # Show all volume instances separately
#   ./scripts/maintenance/list-backups.sh --stage          # Query the stage cluster's Longhorn API
#   ./scripts/maintenance/list-backups.sh --source-env prod
# =============================================================================
...
echo "  ./scripts/maintenance/restore-app.sh --prod --app bookstack"
echo "  ./scripts/maintenance/restore-cluster.sh --stage --from prod"
