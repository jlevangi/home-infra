...
public class EpprRoomAuth {
	...
	@Value("${act.room.RoomAuth.serverPublicHost}")
	private String serverPublicHost;
	
	@Value("${act.room.RoomAuth.serverPublicPort}")
	private String serverPublicPort;
	...
	public Handshake getHandshakeSchema() {
		...
		handshake.serverPublicAP = (serverPublicHost == null) ? getMyLocalIP() : serverPublicHost;
		handshake.serverPublicAP += ":" + (serverPublicPort == null ? serverPort : serverPublicPort);
		return handshake;
	}
