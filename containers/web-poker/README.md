...
docker build -f containers/web-poker/backend/Dockerfile.api -t jlevangie/gamble-king:api-20260429-1 .
docker build -f containers/web-poker/backend/Dockerfile.orchestrator -t jlevangie/gamble-king:orchestrator-20260429-1 .
