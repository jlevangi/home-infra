...
| `share.levangie.dev` | 28 | `levangie.dev` | `CNAME e163e2bb-e184-41aa-a96b-eb1dbdb99418.cfargotunnel.com`; proxied=true; ID `ea17b40a7a1700cae2e5ca2e100b7db3` | `https://k3s-prod.levangie.dev` | `pingvin-share-x/pingvin-share-x` | public Pingvin Share X; approved and active | active | DNS/TLS/HTTP + OIDC redirect + reverse-share upload |
| `gallery.everlyera.com` | 31 (live 2026-08-10) | `everlyera.com` | proxied `CNAME e163e2bb-e184-41aa-a96b-eb1dbdb99418.cfargotunnel.com` | `https://k3s-prod.levangie.dev` with gallery Host/SNI | `everlyera-galleries/everlyera-gallery-ingress` | public Everly Era client-gallery pilot; approved and active | active | DNS/TLS/HTTP + Immich landing page |
| `<catch-all>` | 29 | n/a | n/a | `http_status:404` | n/a | required deny fallback | n/a | unmatched URL returns 404 |

## Findings

- 29 hostname routes plus one catch-all after adding FileBrowser Quantum at `cloud.levangie.dev` and Pingvin Share X at `share.levangie.dev`.
