...
| --- | --- | --- | --- |
| `prod` | Primary production cluster | `172.20.20.101-107` | `levangie.dev` |
| `stage` | Production-like validation | `172.20.21.111-114` | `stage.levangie.dev` |
| `test` | Lower-risk testing | `172.20.21.121-124` | `test.levangie.dev` |
